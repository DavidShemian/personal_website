...
import { SMALL_RUMBLE_DESCRIPTION, IDC_DESCRIPTION, XPERITI_DESCRIPTION } from '../constants/Texts';
...
const PastWork = () => (
    <CenteredContainer id={'PastWork'}>
        ...
        <Card
            src='https://i.ibb.co/61BgjTv/xperiti.jpg'
            name='Xperiti'
            title='Fullstack engineer'
            dates='August 2018 - present'
            text={XPERITI_DESCRIPTION}
        />
        <Card
