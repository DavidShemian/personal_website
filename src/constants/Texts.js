...
export const NODE_JS_DESCRIPTION = `Built, maintained and expanded a Node js server which runs with express. \
Familiar with best practices and design patterns in Node, \
as well as security measurements for the server.`

export const REACT_DESCRIPTION = `Built and maintained a complete external web app for my company using react, which included forms, graphs and much more, \
